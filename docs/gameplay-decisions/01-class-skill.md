...
- **Lifespan**: a summon vanishes after it has **taken its turn N times** (N = 2 for Ninja's clone, 3 for all 4 of Summoner's minion types) — a skipped/stunned turn does **not** count toward N. It also vanishes immediately if its HP reaches 0.
